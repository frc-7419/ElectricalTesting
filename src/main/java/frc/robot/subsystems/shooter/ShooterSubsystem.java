...
public class ShooterSubsystem extends MusicSubsystem{
    private static final TalonFX bottomFalcon = new TalonFX(CanIds.bottomShooterFalcon.id);
    private static final TalonFX topFalcon = new TalonFX(CanIds.topShooterFalcon.id);
