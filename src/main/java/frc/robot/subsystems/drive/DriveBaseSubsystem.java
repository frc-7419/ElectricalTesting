...
public class DriveBaseSubsystem extends MusicSubsystem {
    public static final TalonFX left1  = new TalonFX(CanIds.leftFalcon1.id);
    public static final TalonFX right1 = new TalonFX(CanIds.rightFalcon1.id);
	  public static final TalonFX left2  = new TalonFX(CanIds.leftFalcon2.id);
    public static final TalonFX right2 = new TalonFX(CanIds.rightFalcon2.id);
  
  public DriveBaseSubsystem() {
    super(right1, right2, left1, left2);
    factoryResetAll();
