...
public class ElevatorSubsystem extends MusicSubsystem {
  private final static TalonFX elevatorLeft = new TalonFX(CanIds.leftElevatorFalcon.id);
  private final static TalonFX elevatorRight = new TalonFX(CanIds.rightElevatorFalcon.id);

  public ElevatorSubsystem() {
    super(elevatorLeft, elevatorRight);
